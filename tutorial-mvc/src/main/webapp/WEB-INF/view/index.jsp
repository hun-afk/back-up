...
<body>
	...
	<p>
		...
		(그중에 jsp 에 선언된 변수는 출력할 수 없다. n = ${n } )  
	</p>
	<p>
		EL tag 는 영역에 setAttribute 된 데이터 출략을 지원한다.
	</p>	
	<ul>
	...
	<p>
		...
		생략을 하면 request 에서 찾고, session 에서 찾고, application 에서 찾아서 알아서 출력된다.
	</p>
	<ul>
	...
	<p>
		보통 requestScope 의 데이터 출력을 할때는 보통 지정하지 않고, session 이나 application 의 데이터값은
		scope 를 붙여서 접근한다.
	</p>
</body>
</html>
